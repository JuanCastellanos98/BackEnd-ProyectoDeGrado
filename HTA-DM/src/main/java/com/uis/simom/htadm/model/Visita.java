...
public class Visita {
	...
	public Visita(int id, double altura, double calorias, int dbp, int sbp, int edad, int fumar, int herencia,
			...
			String recomendaciones, String observaciones, int dormir, String alcohol, String estres, String dieta,
			String alimentacion, String ejercicio, double rHTA, double rDM2, double iMC, double pAL,
			LocalDate create_at) {
		super();
		this.id = id;
		this.altura = altura;
	...
	public double getRHTA() {
		return RHTA;
	}

	public void setRHTA(double rHTA) {
		RHTA = rHTA;
	}

	public double getRDM2() {
		return RDM2;
	}

	public void setRDM2(double rDM2) {
		RDM2 = rDM2;
	}
